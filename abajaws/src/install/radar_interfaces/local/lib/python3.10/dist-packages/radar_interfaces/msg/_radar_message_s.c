...
bool radar_interfaces__msg__radar_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("radar_interfaces.msg._radar_message.RadarMessage", full_classname_dest, 48) == 0);
  }
  radar_interfaces__msg__RadarMessage * ros_message = _ros_message;
  {  // target_id
...
{
  /* NOTE(esteve): Call constructor of RadarMessage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("radar_interfaces.msg._radar_message");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RadarMessage");
